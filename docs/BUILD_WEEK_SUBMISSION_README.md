# Archived Build Week submission README

> Historical application-facing copy from the OpenAI Build Week submission branch.
> Preserved so the deterministic submission audit remains reproducible after the
> repository landing page was curated for Faber Proof's current research scope.
# Faber Proof
